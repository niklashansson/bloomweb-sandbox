...
(() => {
  ...
  window.Webflow.push(() => {
    ...
    const currentFrame = (index) => (
      ...
      `https://bloomweb.b-cdn.net/Haglofs/haglofs-hero-${(index + 1).toString().padStart(5, "0")}.webp`
    );
    const images = [];
    const airpods = {
      frame: 0
    ...
    images[0].onload = render3;
    function render3() {
      context3.clearRect(0, 0, canvas.width, canvas.height);
      context3.drawImage(images[airpods.frame], 0, 0);
    }
  });
})();
